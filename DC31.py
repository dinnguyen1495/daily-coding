...
def levenshtein_distance_rec(str1, str2):
    ...
    if str1[-1] == str2[-1]:
        ...
        cost = 1
    return min(levenshtein_distance_rec(str1[:-1], str2) + 1, 
        levenshtein_distance_rec(str1, str2[:-1]) + 1, 
        levenshtein_distance_rec(str1[:-1], str2[:-1]) + cost)
...
def main():
    def test(str1, str2):
        print("Levenshtein distance between \"" + str1 + "\" and \"" + str2 + "\" is:"
            , levenshtein_distance_iter(str1, str2))
    test('kitten', 'sitting')
